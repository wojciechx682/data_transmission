...
int main()
{
    ...
    fstream file_c;
    file_c.open("c_ASK.csv", ios::out | ios::app);
    cout << "zapisywanie do pliku c_ASK.txt = " << endl;
    for (int n = 0; n < N; n++)
    {
        if (file_c.good() == true)
        {
    ...
    // Zamiana sygnału c(t) (c_ASK) na tablicę zawierającą bity:
    ...
    // FUNKCJA KONWERRUJĄCA SYGNAŁ c(t) NA CIĄG BITÓW :
    int binary_one = 0;
    int binary_zero = 0;
    ...
    for (int i = 0; i < B; i++)
    {
        ...
        if (binary_zero > (0.65 * ilosc_probek))
        {           
            b_out[i] = 0;
        }
        if (binary_zero < (0.65 * ilosc_probek))
    ...
    fstream file_c_ZP;
    file_c_ZP.open("c_PSK.csv", ios::out | ios::app);
    cout << "zapisywanie do pliku c_PSK.txt = " << endl;
    for (int n = 0; n < N; n++)
    {
    ...
    cout << "zapisywanie do pliku ZF_1.txt = " << endl;
    for (int n = 0; n < N; n++)
    {
        if (file4.good() == true)
        {
    ...
    cout << " Demodulacja FSK - ZF(t)  - sygnał x1(t) = " << endl;
    ...
    cout << "zapisywanie do pliku x1_ZF.txt = " << endl;
    for (int n = 0; n < N; n++)
    {
    ...
    cout << "koniec zapisu do pliku x_ZF.txt = " << endl;



    // x2

    cout << " Demodulacja FSK - ZF(t)  - sygnał x2(t) = " << endl;
    ...
    cout << "koniec zapisu do pliku x2_ZF.txt = " << endl;

    // całkowanie x1:

    cout << "Całkowanie sygnału x1_ZF(t) = " << endl;
    ...
    cout << "zapisywanie do pliku p1_ZF.txt = " << endl;
    for (int n = 0; n < N; n++)
    {
    ...
    cout << " KONIEC: zapisywanie do pliku p1_ZF.txt = " << endl;

    // całkowanie x2:

    cout << "Całkowanie sygnału x2_ZF(t) = " << endl;
    ...
    cout << "zapisywanie do pliku p2_ZF.txt = " << endl;
    for (int n = 0; n < N; n++)
    {
    ...
    cout << " KONIEC: zapisywanie do pliku p2_ZF.txt = " << endl;



    cout << " Dodawanie sygnałów p1 i p2 = " << endl;
    ...
    cout << "zapisywanie do pliku p_ZF.txt = " << endl;
    for (int n = 0; n < N; n++)
    {
    ...
    cout << " KONIEC: zapisywanie do pliku p_ZF.txt = " << endl;

    cout << " sygnał wyjściowy c(t) (ZF) = " << endl;
    ...
    fstream file_c_ZF;
    file_c_ZF.open("c_FSK.csv", ios::out | ios::app);
    cout << "zapisywanie do pliku c_FSK.txt = " << endl;
    for (int n = 0; n < N; n++)
    {
